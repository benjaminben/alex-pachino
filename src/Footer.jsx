    ...
    return(
      <footer className="table width100 absolute">
        <span className="table-cell text-center v-middle">
          <a className="link inline-block" target="_blank" href="https://alexpachino.tumblr.com">
            <img className="icon" src="/assets/Social/tumblr-icon-black.svg" />
          </a>
          <a className="link inline-block" target="_blank" href="https://www.instagram.com/alex_pachino/">
